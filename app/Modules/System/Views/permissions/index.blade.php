    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"> List Permissions</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                                    ...
                                                    <tr>
                                                        <td class="center"><label class="pos-rel">
                                                                <input type="checkbox" class="ace mycheckbox"
                                                                       value="{{ $permission->id }}" name="check[]">
                                                                <span class="lbl"></span> </label>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="action-buttons">
                                                                <a href="{{ url($backendUrl.'/permissions/'.$permission->id.'/edit') }}">
                                                                    <span class="btn btn-sm btn-warning">
                                                                        <i title="Sửa" class="ace-icon fas fa-pen mr-0"></i> </span>
                                                                </a>
                                                                <a href="#" name="{{ $permission->name }}"
                                                                   link="{{ url($backendUrl.'/permissions/'.$permission->id) }}"
                                                                   class="deleteClick red id-btn-dialog2"
                                                                   data-toggle="modal" data-target="#deleteModal">
                                                                    <span class="btn btn-sm btn-danger">
                                                                        <i title="Delete" class="ace-icon fas fa-trash mr-0"></i></span></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
