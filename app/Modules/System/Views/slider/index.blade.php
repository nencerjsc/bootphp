                                                    ...
                                                    <div class="text-left">
                                                        <a class="btn btn-success bg-gradient"
                                                           href="{{ url($backendUrl.'/sliders/create') }}">
                                                            <i class="fas fa-plus mr-1"></i>Create New Sliders
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <table class="table thead-light">
                                                ...
                                                @foreach( $sliders as $slide )
                                                    <tr>
                                                        ...
                                                        <td>@if($slide->sort_order) {{ $slide->sort_order }} @else
                                                                0 @endif</td>
                                                        <td>{{ $slide->lang }}</td>
                                                        <td>
                                                            <div data-table="sliders" data-id="{{ $slide->id }}"
                                                                 data-col="status"
                                                                ...
                                                                <input data-toggle="tooltip" name="default" id="status"
                                                                       @if($slide->status == 1) value="status" checked
                                                                       @else value="" @endif
