                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="symbol_left" type="text" class="form-control" id="url"
                                           placeholder="Enter Symbol Left" value="{{ $currency->symbol_left}}">
                                </div>

                                <div class="form-group">
                                    <label for="symbol_right">Ký hiệu phải:</label>
                                    <input name="symbol_right" type="text" class="form-control" id="symbol_right"
                                           placeholder="Enter Symbol Right" value="{{ $currency->symbol_right}}">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="1" @if($currency->status == 1) selected @endif>Bật</option>
                                        <option value="0" @if($currency->status == 0) selected @endif>Tắt</option>
                                    </select>
                                </div>
                            </div>
