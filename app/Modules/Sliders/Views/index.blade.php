                                    ...
                                    <div class="col-md-6">
                                        <div class="text-left">
                                            <a class="btn btn-success bg-gradient"
                                               href="{{ url($backendUrl.'/sliders/create') }}">
                                                <i class="fal fa-plus"></i>Create New Sliders
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <table class="table thead-light">
                                    ...
                                    @foreach( $sliders as $slide )
                                        <tr>
                                            ...
                                            <td>{{ \Illuminate\Support\Str::limit($slide->slider_text ?? '',100,' ...') }}</td>
                                            <td>@if($slide->sort_order) {{ $slide->sort_order }} @else 0 @endif</td>
                                            <td>{{ $slide->lang }}</td>
                                            <td>
                                                <div data-table="sliders" data-id="{{ $slide->id }}" data-col="status"
                                                     class="template-administrator24-switch Switch Round @if($slide->status == 1) On @else Off @endif  ">
                                                    <input data-toggle="tooltip" name="default" id="status" @if($slide->status == 1) value="status" checked @else value="" @endif
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="#" name="{{ $slide->slider_name }}" link="{{ url($backendUrl.'/sliders/'.$slide->id) }}"
