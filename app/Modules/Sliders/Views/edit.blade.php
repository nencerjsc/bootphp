                            ...
                            <div class="mt-4 row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="slider_text" id="slider_text" class="form-control" rows="5">{!! $slider->slider_text !!}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="lang">
                                                    @if(count($langs))
                                                        @foreach($langs as $lang)
                                                            <option value="{{$lang->code}}" @if($lang->code == $slider->lang) selected @endif>{{$lang->name}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
