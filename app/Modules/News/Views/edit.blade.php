                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input name="news_slug" type="text" class="form-control" id="news_slug"
                                                       placeholder="Đường dẫn SEO" value="{{ $news->news_slug }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input name="author_email" type="text" class="form-control" id="author_email" value="{{ $news->author_email }}">
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <button type="button" class="btn btn-default" onclick="selectFileWithCKFinder('image', 'logo-icon')">Chọn ảnh</button>
                                                    </div>
                                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input name="publish_date" type="text" class="form-control" id="publish_date" value="{{ $news->publish_date }}">
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input name="meta[title]" type="text" class="form-control" value="{{ $news->meta['title'] ?? null }}" placeholder="Khoảng 60 ký tự">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input name="meta[description]" type="text" class="form-control" value="{{ $news->meta['description'] ?? null }}"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input name="meta[keyword]" type="text" class="form-control" value="{{ $news->meta['keyword'] ?? null }}"
