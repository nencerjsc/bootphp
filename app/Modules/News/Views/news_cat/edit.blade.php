                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <input name="url_key" type="text" class="form-control" id="slug"
                                                               placeholder="Slug" value="{{ $cat->url_key }}">
                                                    </div>
                                                            ...
                                                            @if(count($languages) > 0)
                                                                @foreach($languages as $lang)
                                                                    <option value="{{$lang['code']}}"
                                                                            @if($lang['code'] == $cat->language) selected @endif>
                                                                        {{$lang['name']}}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                                ...
                                                                @if(count($cat_lists) > 0)
                                                                    @foreach($cat_lists as  $cat_name)
                                                                        <option value="{{$cat_name->id}}"
                                                                                @if($cat->parent_id == $cat_name->id) selected @endif>
                                                                            {{$cat_name->name}}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select class="form-control" name="status" id="status">
                                                            <option value="1"
                                                                    @if($cat->status == 1) selected="selected" @endif>
                                                                Active
                                                            </option>
                                                            <option value="0"
                                                                    @if($cat->status == 0) selected="selected" @endif>
                                                                disabled
                                                            </option>
                                                        </select>
                                                    </div>
