                                    ...
                                    <div class="col-md-6">
                                        <div class="text-left">
                                            <a class="btn btn-success bg-gradient"
                                               href="{{ url($backendUrl.'/news_cat/create') }}">
                                                <i class="fal fa-plus"></i>Create New Category
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <table class="table thead-light">
                                    ...
                                    @foreach( $cats as $name => $cat )
                                        <tr>
                                            ...
                                            <td>{{ $cat->parent_id }}</td>
                                            <td>
                                                <div data-table="news_cats" data-id="{{ $cat->id }}" data-col="status"
                                                     class="template-administrator24-switch Switch Round @if($cat->status == 1) On @else Off @endif  ">
                                                    <input data-toggle="tooltip" name="default" id="status" @if($cat->status == 1) value="status" checked @else value="" @endif
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    <a href="{{ url($backendUrl.'/news_cat/'.$cat->id.'/edit') }}">
                                                        <span class="btn btn-sm btn-warning"> <i title="Sửa" class="ace-icon fa fa-pencil mr-0"></i> </span>
                                                    </a>
                                                    <a href="#" name="{{ $cat->name }}" link="{{ url($backendUrl.'/news_cat/'.$cat->id) }}"
