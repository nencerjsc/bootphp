                                                    ...
                                                    <div class="text-left">
                                                        ...
                                                        <a class="btn btn-info bg-gradient"
                                                           href="{{ route('news_cat.index') }}">
                                                            <i class="fas fa-plus mr-1"></i>Danh mục
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <table class="table thead-light">
                                                ...
                                                @foreach( $news as $post )
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset($post->image) }}" width="80" height="70">
                                                        </td>
                                                        <td><a href="{{url('news/'.$post->news_slug)}}.html"
                                                               target="_blank">{{ $post->title }}</a></td>
                                                        <td>{{ $post->author }}</td>
                                                        <td>{{ $post->language }}</td>
                                                        <td>
                                                            <div data-table="news" data-id="{{ $post->id }}"
                                                                 data-col="status"
                                                                ...
                                                                <input data-toggle="tooltip" name="default" id="status"
                                                                       @if($post->status == 1) value="status" checked
                                                                       @else value="" @endif
                                                        ...
                                                        <td>
                                                            <div class="action-buttons">
                                                                ...
                                                                <a href="#" name="{{ $post->title }}"
                                                                   link="{{ url($backendUrl.'/news/'.$post->id) }}"
