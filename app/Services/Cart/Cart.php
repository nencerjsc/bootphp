...
use App\Services\Cart\Contracts\InstanceIdentifier;
...
class Cart
{
     ...
     * @param array     $options
     *
     * @return \App\Services\Cart\CartItem
     */
